...
export default function ErrorPage() {
  return (
    <main className="relative flex h-screen flex-col items-center justify-center overflow-hidden bg-[hsl(225,10%,77%)] text-[hsl(210,4%,10%)]">
      {/* Background gradient */}
      ...
      >
        <h1 className="text-[clamp(3rem,10vw,6rem)] font-extrabold leading-tight text-[hsl(0,89%,59%)]">
          404
        </h1>
